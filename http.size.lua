...
MAX_PATHS=tonumber(os.getenv("maxpaths"))
THREADS=16
--IPADDR="10.1.4.100"
IPADDR=os.getenv("dip1")
--FSIZE=262144
FSIZE=tonumber(os.getenv("fsize"))
MODE=os.getenv("mode")
...
request = function()
	...
	url_path = string.format("%s://%s/nginx.%d/file.%d.html", MODE, IPADDR, FSIZE, counter * THREADS + tid)
