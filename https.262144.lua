...
request = function()
	...
	--url_path = string.format("https://10.1.4.100/file.%d.html", math.random(MAX_PATHS))
	--https://10.1.4.100/nginx.4096/file.0.html
	url_path = string.format("https://%s/nginx.%d/file.%d.html", IPADDR, FSIZE, counter * THREADS + tid)
	--print("Requesting thread " .. tid )
	--print("Requesting url " .. url_path )
